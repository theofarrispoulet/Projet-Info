...
set output "t2_png" #On indique que le fichier de sortie doit s'appeler t2_png.
set title "Température t2" #On définie "Température t2" comme titre du graphique.
...
set ylabel "Température moyenne" #On définie "Température moyenne" comme nom de l'axe des ordonnées.
